...
import com.new9appsmarketappsandroidapp.nineapps9appsmarket.apps999.Ads.Ad_Constant;
import com.new9appsmarketappsandroidapp.nineapps9appsmarket.apps999.Ads.AdmobAdsTemplete;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_privacy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                build.launchUrl(getApplicationContext(), Uri.parse("https://tuhinsapps77.blogspot.com/2022/04/guide-for-9app-mobile-market.html"));
