...
import com.freegetapps.fantacy.guideforlulubox7777.Ads.AdmobAdsTemplete;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_privacy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                build.launchUrl(getApplicationContext(), Uri.parse("https://tuhinsapps77.blogspot.com/2022/04/lulubox-lulubox-skin-guide.html"));
